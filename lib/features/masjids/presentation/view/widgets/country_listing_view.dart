      ...
      child: Column(
        children: [
          Container(
              ...
              child: const Text('Countries',style: TextStyle(fontSize: 16,color: AppColors.textPrimary2Color,fontWeight: FontWeight.w500),)),
          Expanded(
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return MasjidLocationItemView(
                        isSelected: state.selectedCountry == state.countryList[index],
                        entity: state.countryList[index],
                        onDoubleTap: () =>
                            BlocProvider.of<MasjidViewModelCubit>(context)
                                .onCountryDoubleTap(state.countryList[index]),
                      );
                    },
                  );
                }
