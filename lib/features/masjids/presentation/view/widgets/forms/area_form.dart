        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              const AppTextField(hintText: AppStrings.hCountry, height: 40),
              const AppTextField(hintText: AppStrings.hState, height: 40),
              const AppTextField(hintText: AppStrings.hState, height: 40),
              const AppTextField(hintText: AppStrings.hCity, height: 40),
              ...
              Row(
                children: [
                  ...
                  Expanded(
                      child: CommonButton(
                          height: 40, onTap: () {}, text: AppStrings.update)),
                ],
              )
            ],
          ),
