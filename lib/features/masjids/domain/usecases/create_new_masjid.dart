...
class CreateNewMasjid extends BaseUseCase<MasjidEntity, CreateNewMasjidParams> {

  CreateNewMasjid({required this.masjidsRepository});

  final MasjidsRepository masjidsRepository;
  @override
  Future<DataSourceResult<MasjidEntity>> call(CreateNewMasjidParams params) {
    return masjidsRepository.createNewMasjid(createNewMasjidParams: params);

  }
}

class CreateNewMasjidParams extends Equatable {
