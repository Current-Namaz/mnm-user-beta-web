...
class UpdateConfigByCountryUseCase extends BaseUseCase<String,CityConfigEntity>{

  UpdateConfigByCountryUseCase({required this.cityConfigRepository});

  final CityConfigRepository cityConfigRepository;

  @override
  Future<DataSourceResult<String>> call(CityConfigEntity params)async {
    return await cityConfigRepository.updateConfigByCountry(cityConfigEntity: params);
  }
}